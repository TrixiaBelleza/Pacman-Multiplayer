...
class ServerHandler(socket.socket, threading.Thread):
    ...
    def __init__(self, bind_address, server_address, client_command=None):
    ...
    def run(self):
        ...
        while True:
        	print("Player " + self.player_number + " connencted.")
    ...
    def connect(self):
        self.sendto(pacmanserver.server.PacmanServer.COMMAND_CLIENT_CONNECT.encode('utf-8'), self.server_address)
        return
